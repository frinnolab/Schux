            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                            ...
                            <?php
                                ...
                                if(count($vendors)) {
                                    foreach ($vendors as $vendor) {
                                        $vendor_array[$vendor->productsupplierID] = $vendor->productsuppliercompanyname;
                                    }
                                }
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                echo form_dropdown("unit", array(0 => $this->lang->line('purchase_select_unit'), 1 => $this->lang->line('purchase_unit_kg'), 2 => $this->lang->line('purchase_unit_piece'), 3 => $this->lang->line('purchase_unit_box')), set_value("unit", $purchase->unit), "id='unit' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
