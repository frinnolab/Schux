                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <?php 
                        if(form_error('max_mark')) 
                            ...
                            echo "<div class='form-group' >";
                    ?>
                        <label for="max_mark" class="col-sm-2 control-label">
                            <?=$this->lang->line("exam_max_mark")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="max_mark" name="max_mark" value="<?=set_value('max_mark', $exam->max_mark)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
