        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <?php 
                        if(form_error('classes_segragation')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="classes_segragation" class="col-sm-2 control-label">
                            <?=$this->lang->line("classes_segragation")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="classes_segragation" name="classes_segragation" value="<?=set_value('classes_segragation', $classes->classes_segragation);?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('classes_segragation'); ?>
                        </span>
