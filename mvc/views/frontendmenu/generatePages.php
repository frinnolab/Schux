...
<li class="<?=isset($mergeelement['child']) ? 'mjs-nestedSortable-branch mjs-nestedSortable-expanded' : 'mjs-nestedSortable-leaf'?>" id="<?=$mergeelement['menu_rand']?>">
	<div class="panel panel-default ui-sortable-handle <?=$mergeelement['menu_pagesID'].'-'.$rand?>" data-id="<?=$mergeelement['menu_pagesID']?>" data-type-id="1" data-rand="<?=$mergeelement['menu_rand']?>">
				...
				<form class="menu-page">
		    		...
		    		<div class="form-group ui-sortable-handle">
		    			<div class="link-to-original ui-sortable-handle">
		    				...
		    				<a target="_blank" href="<?=isset($pluckpages[$mergeelement['menu_pagesID']]) ? base_url('frontend/page/'.$pluckpages[$mergeelement['menu_pagesID']]->url) : base_url('frontend/page/#')?>"><?=isset($pluckpages[$mergeelement['menu_pagesID']]) ? $pluckpages[$mergeelement['menu_pagesID']]->title : $mergeelement['menu_label']?></a>
		    			</div>
		    		</div>
		    		<div class="form-group ui-sortable-handle">
