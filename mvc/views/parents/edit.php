        ...
        <div class="row">
            <div class="col-sm-10">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <?php
                        if(form_error('father_phone'))
                            echo "<div class='form-group has-error' >";
                        else
                            echo "<div class='form-group' >";
                    ?>
                        <label for="father_phone" class="col-sm-2 control-label">
                            <?=$this->lang->line("father_phone")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="father_phone" name="father_phone" value="<?=set_value('phone', $parents->father_phone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php
                        if(form_error('father_alternate_phone'))
                            echo "<div class='form-group has-error' >";
                        else
                            echo "<div class='form-group' >";
                    ?>
                        <label for="father_alternate_phone" class="col-sm-2 control-label">
                            <?=$this->lang->line("father_alternate_phone")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="father_alternate_phone" name="father_alternate_phone" value="<?=set_value('phone', $parents->father_alternate_phone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('father_alternate_phone'); ?>
                        </span>
                    </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="mother_phone" name="mother_phone" value="<?=set_value('phone', $parents->mother_phone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php 
                        if(form_error('country')) 
                            ...
                            echo "<div class='form-group' >";
                    ?>
                        <label for="father_country" class="col-sm-2 control-label">
                            <?=$this->lang->line("father_country")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                            ...
                            ?>
                            <?php 
                                echo form_dropdown("father_country", $country, set_value("father_country", $parents->father_country), "id='country' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('father_country'); ?>
                        </span>
                    </div>

                    <?php 
                        if(form_error('mother_country')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="mother_country" class="col-sm-2 control-label">
                            <?=$this->lang->line("mother_country")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                $country['0'] = $this->lang->line('student_select_country');  
                            ...
                            ?>
                            <?php 
                                echo form_dropdown("mother_country", $country, set_value("mother_country", $parents->mother_country), "id='country' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('mother_country'); ?>
                        </span>
                    </div>

                    <?php
                        if(form_error('mother_alternate_phone'))
                            echo "<div class='form-group has-error' >";
                        else
                            echo "<div class='form-group' >";
                    ?>
                        <label for="mother_alternate_phone" class="col-sm-2 control-label">
                            <?=$this->lang->line("mother_alternate_phone")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="mother_alternate_phone" name="mother_alternate_phone" value="<?=set_value('phone', $parents->mother_alternate_phone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('mother_alternate_phone'); ?>
                        </span>
                    </div>
