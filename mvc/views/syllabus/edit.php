                ...
                <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post">
                    ...
                    ?>
                        <label for="description" class="col-sm-2 control-label">
                            <?=$this->lang->line("syllabus_component")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input class="form-control" style="resize:none;" id="description" name="description" value="<?=set_value('description', $syllabus->description)?>">
                        </div>
                        <span class="col-sm-4 control-label">
