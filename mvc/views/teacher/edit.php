                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        <label for="alternate_phone" class="col-sm-2 control-label">
                            <?=$this->lang->line("teacher_alternate_phone")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="alternate_phone" name="alternate_phone" value="<?=set_value('alternate_phone', $teacher->alternate_phone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="country" class="col-sm-2 control-label">
                            <?=$this->lang->line("teacher_country")?>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                $country['0'] = $this->lang->line('teacher_select_country');  
                                foreach ($allcountry as $allcountryKey => $allcountryit) {
                                    $country[$allcountryKey] = $allcountryit;
                                }
                            ?>
                            <?php 
                                echo form_dropdown("country", $country, set_value("country", $teacher->country), "id='country' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
