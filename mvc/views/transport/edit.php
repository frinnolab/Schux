            ...
            <div class="col-sm-10">
                ...
                <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="transport_owner" name="transport_owner" value="<?=set_value('transport_owner', $transport->transport_owner)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="transport_owner_phone" name="transport_owner_phone" value="<?=set_value('transport_owner_phone', $transport->transport_owner_phone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="transport_owner_alternate_phone" name="transport_owner_alternate_phone" value="<?=set_value('transport_owner_alternate_phone', $transport->transport_owner_alternate_phone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="transport_driver" name="transport_driver" value="<?=set_value('transport_driver', $transport->transport_driver)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="transport_driver_phone" name="transport_driver_phone" value="<?=set_value('transport_driver_phone', $transport->transport_driver_phone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="transport_driver_alternate_phone" name="transport_driver_alternate_phone" value="<?=set_value('transport_driver_alternate_phone', $transport->transport_driver_alternate_phone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="capacity" name="capacity" value="<?=set_value('capacity', $transport->capacity)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
