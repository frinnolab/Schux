        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group <?=form_error('productsuppliertin') ? 'has-error' : '' ?>" >
                        <label for="productsuppliertin" class="col-sm-2 control-label">
                            <?=$this->lang->line("productsupplier_tin")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsuppliertin" name="productsuppliertin" value="<?=set_value('productsuppliertin', $productsupplier->productsuppliertin)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('productsuppliertin'); ?>
                        </span>
                    </div>
                    
                    <div class="form-group <?=form_error('productsuppliervrn') ? 'has-error' : '' ?>" >
                        <label for="productsuppliervrn" class="col-sm-2 control-label">
                            <?=$this->lang->line("productsupplier_vrn")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsuppliervrn" name="productsuppliervrn" value="<?=set_value('productsuppliervrn', $productsupplier->productsuppliervrn)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('productsuppliervrn'); ?>
                        </span>
                    </div>
                    ...
                    <div class="form-group <?=form_error('productsupplieralternatephone') ? 'has-error' : '' ?>" >
                        <label for="productsupplieralternatephone" class="col-sm-2 control-label">
                            <?=$this->lang->line("productsupplier_alternate_phone")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsupplieralternatephone" name="productsupplieralternatephone" value="<?=set_value('productsupplieralternatephone', $productsupplier->productsupplieralternatephone)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('productsupplieralternatephone'); ?>
                        </span>
                    </div>
