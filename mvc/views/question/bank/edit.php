            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                            $array = array(null => $this->lang->line("question_bank_select"));
                            foreach ($classes as $class) {
                                $array[$class->classesID] = $class->classes;
                            }
                            echo form_dropdown("class", $array, set_value("class", $question_bank->classID), "id='class' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("subject", $array, set_value("subject", $question_bank->subjectID), "id='subject' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="year" class="col-sm-2 control-label">
                            <?=$this->lang->line("question_bank_year")?> <span class='text-red'>*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="year" name="year" value="<?=set_value('year', $question_bank->year)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="type" class="col-sm-2 control-label">
                            <?=$this->lang->line("question_bank_type")?>
                        </label>
                        <div class="col-sm-6">
                            <?php
                            $array = array(0 => $this->lang->line("question_bank_select"));
...
<script type="text/javascript">
    ...
    $('#class').on('change', function(){
        ...
        subjects = subjects.filter(subject => {
            return subject.classesID === classID
        })
        $('#subject').html('');
        subjects_options = subjects.map(subject=> {
                                            $('#subject').append(`<option value=${subject.subjectID}>${subject.subject}</option>`)
                                        });
    })
