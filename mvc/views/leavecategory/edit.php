<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_leavecategory')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group <?=form_error('leavecategory') ? 'has-error' : ''?>">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="leavecategory" name="leavecategory" value="<?=set_value('leavecategory', $leavecategory->leavecategory)?>" >
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_leavecategory")?>" >
                        </div>
                    </div>
                </form>
            </div>
