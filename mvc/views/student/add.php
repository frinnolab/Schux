            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="alternate_phone" name="alternate_phone" value="<?=set_value('alternate_phone')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('optionalSubjectID') ? ' has-error' : ''  ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_multiselect("optionalSubjectID[]", $optionalSubjectArray, set_value("optionalSubjectID", $optionalSubjectID), "id='optionalSubjectID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                ...
                <?php if ($siteinfos->note==1) { ?>
                    <div class="callout callout-danger">
                        <p><b>Note:</b> Create teacher, class, stream before create a new student.</p>
                    </div>
                <?php } ?>
            </div> <!-- col-sm-8 -->
