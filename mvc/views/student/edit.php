        ...
        <div class="row">
            <div class="col-sm-10">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <?php 
                        // if(form_error('alternate_phone')) 
                        //     echo "<div class='form-group has-error' >";
                        // else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="alternate_phone" class="col-sm-2 control-label">
                            <?=$this->lang->line("student_alternate_phone")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="alternate_phone" name="alternate_phone" value="<?=set_value('alternate_phone', $student->alternate_phone)?>" >
                        </div>
                        <!-- <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('optionalSubjectID') ? ' has-error' : ''  ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_multiselect("optionalSubjectID[]", $optionalSubjectArray, set_value("optionalSubjectID", json_decode($student->sroptionalsubjectID)), "id='optionalSubjectID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="registerNO" name="registerNO" value="<?=set_value('registerNO', $student->unique_number)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php 
                        if(form_error('admission_status')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="admission_status" class="col-sm-2 control-label">
                            <?=$this->lang->line("student_admission_status")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="admission_status" id="admission_status" class="admitted" value="1" <?= $student->isAdmitted ? 'checked' : '' ?> >
                                    Admitted
                                </label>
                            </div>
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="admission_status" id="admission_status" class="not_admitted" value="0" <?= !$student->isAdmitted ? 'checked' : '' ?> >
                                    No Longer Admitted
                                </label>
                            </div>
                        </div>
                    ...
                    <?php 
                        if(form_error('reason_for_non_admission')) 
                            echo "<div class='form-group has-error collapse' id='collapse' >";
                        else     
                            echo "<div class='form-group collapse' id='collapse' >";
                    ?>
                        <label for="reason_for_non_admission" class="col-sm-2 control-label">
                            <?=$this->lang->line("reason_for_non_admission")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="reason_for_non_admission" name="reason_for_non_admission" value="<?=set_value('reason_for_non_admission', $student->reason_for_non_admission)?>" >
                        </div>
                         <span class="col-sm-4 control-label">
                            <?php echo form_error('reason_for_non_admission'); ?>
                        </span>
                    </div>
...
$('.admitted').click(function() {
    $('#collapse').collapse('hide')
})

$('.not_admitted').click(function() {
