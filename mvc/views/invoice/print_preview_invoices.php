	        	...
	        	<td width="60%">
	            	<table >
	              		<tbody>
			                ...
			                <tr>
			                    <td><?php  echo $this->lang->line("student_registerNO"). " : ". $maininvoice->unique_number; ?></td>
			                </tr>
	              		</tbody>
	            	</table>
	        	</td>
		            	...
		            	<tbody>
							  ...
							  <tr>
								  <td width="35%">
									<table>
										<tr>
											<td><?=$this->lang->line('invoice_create_by')?> : <?=$maininvoice->createuser?></td>
										</tr>
										<tr>
	    ...
	    <table class="table table-bordered" width="100%" style="margin-bottom: 0;">
	      	...
	      	<tbody>
                <?php 
                    ...
                    foreach($invoices as $invoice) {
                        if($invoice->maininvoiceID == $maininvoice->maininvoiceID) {
                        $discount = 0; 
                        if($invoice->discount > 0) { 
                            $discount = (($invoice->amount/100) * $invoice->discount); 
                        } 
                        $subtotal = ($invoice->amount - $discount); $totalsubtotal += $subtotal;  
                ?>
		            <tr>
			...
			<tbody>
				<tr>
					...
					<td><b><?=number_format(explode(",",$maininvoice->grandtotalandpayment['grandtotal'])[0], 2)?></b></td>
				</tr>
				<tr>
					<td colspan="5"><span class="pull-right"><b><?=$this->lang->line('invoice_totalamount')?> (GBP)</b></span></td>
					<td><b><?=number_format(explode(",",$maininvoice->grandtotalandpayment['grandtotal'])[1], 2)?></b></td>
				</tr>
				<tr>
					<td colspan="5"><span class="pull-right"><b><?=$this->lang->line('invoice_totalamount')?> (TZS)</b></span></td>
					<td><b><?=number_format(explode(",",$maininvoice->grandtotalandpayment['grandtotal'])[2], 2)?></b></td>
				</tr>
				<?php if ($maininvoice->maininvoicetype == 'invoice') { ?>
				<tr>
					<td colspan="5"><span class="pull-right"><b><?=$this->lang->line('invoice_paid')?> (USD)</b></span></td>
					<td><b><?=number_format(explode(",",$maininvoice->grandtotalandpayment['totalpayment'])[0], 2)?></b></td>
				</tr> 
				<tr>
					<td colspan="5"><span class="pull-right"><b><?=$this->lang->line('invoice_paid')?> (GBP)</b></span></td>
					<td><b><?=number_format(explode(",",$maininvoice->grandtotalandpayment['totalpayment'])[1], 2)?></b></td>
				</tr> 
				<tr>
					<td colspan="5"><span class="pull-right"><b><?=$this->lang->line('invoice_paid')?> (TZS)</b></span></td>
					<td><b><?=number_format(explode(",",$maininvoice->grandtotalandpayment['totalpayment'])[2], 2)?></b></td>
				</tr> 
				<tr>
					<td colspan="5"><span class="pull-right"><b><?=$this->lang->line('invoice_balance');?> (USD)</b></span></td>
					<td><b><?=number_format(explode(",",$maininvoice->grandtotalandpayment['grandtotal'])[0] - explode(",",$maininvoice->grandtotalandpayment['totalpayment'])[0], 2)?></b></td>
				</tr>
				<tr>
					<td colspan="5"><span class="pull-right"><b><?=$this->lang->line('invoice_balance');?> (GBP)</b></span></td>
					<td><b><?=number_format(explode(",",$maininvoice->grandtotalandpayment['grandtotal'])[1] - explode(",",$maininvoice->grandtotalandpayment['totalpayment'])[1], 2)?></b></td>
				</tr>
				<tr>
					<td colspan="5"><span class="pull-right"><b><?=$this->lang->line('invoice_balance');?> (TZS)</b></span></td>
					<td><b><?=number_format(explode(",",$maininvoice->grandtotalandpayment['grandtotal'])[2] - explode(",",$maininvoice->grandtotalandpayment['totalpayment'])[1], 2)?></b></td>
				</tr>
				<tr>
					<td colspan="5"><span class="pull-right"><b><?=$this->lang->line('invoice_fine');?> (USD)</b></span></td>
					<td><b><?=number_format($maininvoice->grandtotalandpayment['totalfine'], 2)?></b></td>
				</tr>
				<tr>
