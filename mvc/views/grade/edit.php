                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        <label for="classesID" class="col-sm-2 control-label">
                            <?=$this->lang->line('grade_classes')?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                $classArray[0] = $this->lang->line("grade_select_classes");
                                if(count($classes)) {
                                    foreach ($classes as $classa) {
                                        $classArray[$classa->classesID] = $classa->classes;
                                    }
                                }
                                echo form_dropdown("classesID", $classArray, set_value("classesID", $grade->classID), "id='classesID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
