                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1"><?=$this->lang->line('book_subject_code')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('book_price')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('book_quantity')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('book_remaining_quantity')?></th>
                        ...
                        <tbody>
                            <?php if(count($books)) {$i = 1; foreach($books as $book) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('book_remaining_quantity')?>">
